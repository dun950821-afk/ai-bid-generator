  ...
  },
  {
    ...
    children: [
      ...
      // 招标响应模板
      {
        ...
        meta: { title: '响应模板', permission: 'response_template.manage' },
      },
      {
        ...
        meta: { title: '识别响应模板', permission: 'response_template.manage', allowAuthenticated: true },
      },
      {
        ...
        meta: { title: '响应模板详情', permission: 'response_template.manage' },
      },
    ],
  },
]
