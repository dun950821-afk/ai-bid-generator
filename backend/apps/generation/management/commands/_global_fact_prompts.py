...
6. 原文未提及的变量不要编造，不要输出空值变量。
7. 只返回 JSON，格式为 {"groups":[{"key":"","title":"","content":""}]}，不要输出 Markdown 代码块、解释或其他内容。""",
...
4. 已有变量若补充材料中有更准确信息，更新 content 为更完整版本。
5. 不要删除已有变量。
6. 只返回 JSON，格式为 {"groups":[{"key":"","title":"","content":""}]}，不要输出 Markdown 代码块或解释。""",
