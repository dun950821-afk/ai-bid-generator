# Generated manually on 2026-08-03 09:10

"""从 raw_llm_item 回填 score_info/source_page_start/source_section_path/risk_level。

extract 流程此前丢弃 LLM 返回的 score/source_page/source_section，
risk_level 仅写 high/unknown。本次回填存量数据，与新抽取逻辑保持一致。
"""
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("requirements", "0003_add_extraction_metadata_fields"),
    ]
